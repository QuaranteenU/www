  ...
  render() {
    ...
    if (this.props.usingUTC) {
      session1TableContents = session1Rows.map((element) => (
        <tr><td>{element[1]}</td><td>{formatDayOfWeek(new Date(element[0]), true)}, {formatAMPM(new Date(element[0]), true)}</td></tr>
      ));
      ...
      session1TableContents = session1Rows.map((element) => (
        <tr><td>{element[1]}</td><td>{formatDayOfWeek(new Date(element[0]), false)}, {formatAMPM(new Date(element[0]), false)}</td></tr>
      ));
      session2TableContents = session2Rows.map((element) => (
        <tr><td>{element[1]}</td><td>{formatDayOfWeek(new Date(element[0]), false)}, {formatAMPM(new Date(element[0]), false)}</td></tr>
      ));
